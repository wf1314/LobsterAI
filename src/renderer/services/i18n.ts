...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    shortcutOpenCowork: '打开 IndustryAI',
    ...
    shortcutDescNewChat: '开始一个新的 IndustryAI 任务',
    shortcutDescFocusPrompt: '跳回 IndustryAI 并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到 IndustryAI 任务视图',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 IndustryAI Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    coworkWorkingDirectoryHint: 'IndustryAI 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 IndustryAI 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 IndustryAI 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'IndustryAI 使用模型设置中的当前模型与提供商配置。',
    ...
    openClawDataBackupBlockingTitle: '正在备份 IndustryAI 数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入 IndustryAI 数据',
    ...
    openClawDataMigrationConfirmTitle: '导入 IndustryAI 数据备份？',
    ...
    coworkConfigSaveFailed: '保存 IndustryAI 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'IndustryAI 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'IndustryAI 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    browserWebAccessDescription: '使用 IndustryAI 独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: 'IndustryAI 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription: '默认开启。关闭后仅作为 IndustryAI 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: 'IndustryAI 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 IndustryAI 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 IndustryAI 可以打开此域名',
  ...
  en: {
    ...
    shortcutScopeHint: 'Shortcuts only run while the IndustryAI window is focused; global shortcuts are ignored while editing text fields.',
    ...
    shortcutOpenCowork: 'Open IndustryAI',
    ...
    shortcutDescNewChat: 'Start a new IndustryAI task',
    shortcutDescFocusPrompt: 'Return to IndustryAI and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the IndustryAI task view',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit IndustryAI Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    artifactPreviewCardLobsterBrowser: 'IndustryAI Browser',
    artifactPreviewCardOpenInLobsterBrowser: 'Open in IndustryAI Browser',
    ...
    // IndustryAI
    cowork: 'IndustryAI',
    coworkSettings: 'IndustryAI Settings',
    ...
    coworkWorkingDirectoryHint: 'IndustryAI will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for IndustryAI...',
    coworkSystemPromptHint: "Optional system prompt to customize IndustryAI's behavior",
    ...
    coworkModelSettingsHint:
      'IndustryAI uses the current model and provider configuration from Model Settings.',
    ...
    openClawDataBackupBlockingTitle: 'Backing up IndustryAI data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import IndustryAI data',
    ...
    openClawDataMigrationConfirmTitle: 'Import IndustryAI data backup?',
    ...
    coworkConfigSaveFailed: 'Failed to save IndustryAI settings. Please try again.',
    ...
    coworkPermissionDescription: 'IndustryAI is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'IndustryAI needs your input',
    ...
    coworkGatewaySessionSyncTimeout:
      'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add IndustryAI to your antivirus allowlist.',
    ...
    browserWebAccessDescription: 'Use the IndustryAI separate browser and manage page access rules.',
    ...
    browserProfileManagedDescription: 'IndustryAI starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription: 'Enabled by default. Turning it off is stored for IndustryAI, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: 'IndustryAI will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means IndustryAI will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means IndustryAI can open this domain',
